...
exports.SalesforceDataSeedService = void 0;
const databaseService_1 = __importDefault(require("./databaseService"));
class SalesforceDataSeedService {
    constructor() {
    ...
    async generateCryptoTradingAccounts() {
        const accounts = [
            {
    ...
    async generateCryptoContacts(accounts) {
        const contacts = [
            {
                FirstName: 'Sarah',
                LastName: 'Mitchell',
    ...
    async generateCryptoOpportunities(accounts) {
        const opportunities = [
            {
    ...
    async generateCryptoCases(accounts, contacts) {
        const cases = [
            {
                AccountId: accounts[0].Id,
    ...
    async generateCompleteCryptoDataset() {
    ...
    async generateJAGOPSBusinessData() {
        const jagopsData = {
            accounts: [
                {
...
exports.SalesforceDataSeedService = SalesforceDataSeedService;
exports.default = new SalesforceDataSeedService();
//# sourceMappingURL=salesforceDataSeedService.js.map